package WebService::Mattermost::Example::Bot;
...
WebService::Mattermost::Example::Bot
...
=head2 USAGE
    ...
    use WebService::Mattermost::Example::Bot;

    my $bot = WebService::Mattermost::Example::Bot->new({
...
C<WebService::Mattermost::WS::v4>. Each one has one argument passed which is a HashRef
