...
Net::Mattermost::Example::Bot

=head1 DESCRIPTION

An example Mattermost WebSocket bot using C<Net::Mattermost>. The bot connects
...
=head2 USAGE
    ...
    use Net::Mattermost::Example::Bot;

    my $bot = Net::Mattermost::Example::Bot->new({
...
C<Net::Mattermost::WS::v4>. Each one has one argument passed which is a HashRef
